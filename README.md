...
├── products/                   # 제품 하나당 폴더 하나
│   ├── README.md               # 제품 목록 인덱스·제안 대응 문서 작성 현황
│   ├── 작성가이드.md            # 제품 담당자용 작성 가이드
│   ├── _양식/                   # 새 제품 폴더 양식 (통째로 복사)
│   └── <제품명 한글>/
│       ├── README.md           # 제품 설명·기능 계층          ┐
│       ├── slides.md           # 제안 슬라이드 인덱스          │ KB 화면과 1:1 (자동 생성 근거)
│       ├── images/             # 제품 화면 캡쳐 png            ┘
│       ├── 소개서.md            # 소개서·리플릿 위치와 소개 논리 ┐
│       ├── 매뉴얼.md            # 매뉴얼 목록·제공 범위·기술지원  │ 제안 대응 문서
│       ├── 사이징.md            # 데이터 용량별 서버 스펙·이중화  │ (사람이 찾아 씀)
│       └── 제안대응.md          # 요구사항 수용 여부·M/M·일정    ┘
├── business/
│   ├── README.md               # 사업 영역 인덱스
...
> 제품 폴더 안에는 제안 현장에서 반복 요구받는 **제안 대응 문서 4종**(소개서·매뉴얼·사이징·제안대응)도
> 함께 있습니다. 작성 현황은 [products/README.md](./products/README.md) 참조.
...
| 서버 스펙·이중화 구성 변경 | `products/(제품명)/사이징.md` |
| 요구사항 수용 범위·공수 기준 변경 | `products/(제품명)/제안대응.md` |
| 소개서·매뉴얼 개정 | `products/(제품명)/소개서.md`·`매뉴얼.md` 의 버전·위치·최종 갱신일 |
